...
echo $name;
echo $password;
$sql="SELECT * FROM admin_info where name='$name' AND password='$password'";
...
{
   header('Location:login_err2.php');
}
}
...
<br>
<br>
<form name="myform" action="admin_login.php" method="post" onsubmit="return validate_form(this);">
